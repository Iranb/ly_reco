...
class AssociativeEmbeddingCustom(BasePose):
    ...
    def forward(self,
                ...
                bbox_label=None, # add for ly_reco
                img_metas=None,
                return_loss=True,
    ...
    def forward_train(self, img, targets, masks, joints, img_metas, cls_label=None, bbox_label=None,**kwargs):
