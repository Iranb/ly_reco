...
class BottomUpLyingRecoDataset(Kpt2dSviewRgbImgBottomUpDataset):
    ...
    def _get_single(self, idx):
        ...
        category_list = [obj['category_id'] for obj in anno_all]
        bbox_list =  [obj['bbox'] for obj in anno_all]
        ...
        db_rec['cls_label'] = category_list
        db_rec['bbox_label'] = bbox_list
        db_rec['heatmap_size'] = self.ann_info['heatmap_size'] # np.array()
